...
lib LibSqlite3
  ...
  struct Sqlite3Vfs
    ...
    zName : UInt8*
    pAppData : Void*
    xOpen : ((Sqlite3Vfs*, UInt8*, Sqlite3File*, Int32, Int32*) -> Int32)
    xDelete : ((Sqlite3Vfs*, UInt8*, Int32) -> Int32)
    xAccess : ((Sqlite3Vfs*, UInt8*, Int32, Int32*) -> Int32)
    xFullPathname : ((Sqlite3Vfs*, UInt8*, Int32, UInt8*) -> Int32)
    xDlOpen : ((Sqlite3Vfs*, UInt8*) -> Void*)
    xDlError : ((Sqlite3Vfs*, Int32, UInt8*) -> Void)
    xDlSym : ((Sqlite3Vfs*, Void*, UInt8*) -> (( -> Void)))
    xDlClose : ((Sqlite3Vfs*, Void*) -> Void)
    xRandomness : ((Sqlite3Vfs*, Int32, UInt8*) -> Int32)
    xSleep : ((Sqlite3Vfs*, Int32) -> Int32)
    xCurrentTime : ((Sqlite3Vfs*, Float64*) -> Int32)
    xGetLastError : ((Sqlite3Vfs*, Int32, UInt8*) -> Int32)
    xCurrentTimeInt64 : ((Sqlite3Vfs*, Sqlite3Int64*) -> Int32)
    xSetSystemCall : ((Sqlite3Vfs*, UInt8*, Sqlite3SyscallPtr) -> Int32)
    xGetSystemCall : ((Sqlite3Vfs*, UInt8*) -> Sqlite3SyscallPtr)
    xNextSystemCall : ((Sqlite3Vfs*, UInt8*) -> UInt8*)
  end
  ...
  struct Sqlite3Module
    iVersion : Int32
    xCreate : ((Sqlite3*, Void*, Int32, UInt8**, Sqlite3Vtab**, UInt8**) -> Int32)
    xConnect : ((Sqlite3*, Void*, Int32, UInt8**, Sqlite3Vtab**, UInt8**) -> Int32)
    ...
    xFilter : ((Sqlite3VtabCursor*, Int32, UInt8*, Int32, Sqlite3Value**) -> Int32)
    ...
    xFindFunction : ((Sqlite3Vtab*, Int32, UInt8*, ((Sqlite3Context*, Int32, Sqlite3Value**) -> Void)*, Void**) -> Int32)
    xRename : ((Sqlite3Vtab*, UInt8*) -> Int32)
  ...
  struct Fts5ExtensionApi
    ...
    xTokenize : ((Fts5Context*, UInt8*, Int32, Void*, ((Void*, Int32, UInt8*, Int32, Int32, Int32) -> Int32)) -> Int32)
    ...
    xColumnText : ((Fts5Context*, Int32, UInt8**, Int32*) -> Int32)
  ...
  struct Fts5Tokenizer
    xCreate : ((Void*, UInt8**, Int32, Fts5Tokenizer**) -> Int32)
    xDelete : (Fts5Tokenizer* -> Void)
    xTokenize : ((Fts5Tokenizer*, Void*, Int32, UInt8*, Int32, ((Void*, Int32, UInt8*, Int32, Int32, Int32) -> Int32)) -> Int32)
  end
  struct Fts5Api
    iVersion : Int32
    xCreateTokenizer : ((Fts5Api*, UInt8*, Void*, Fts5Tokenizer*, (Void* -> Void)) -> Int32)
    xFindTokenizer : ((Fts5Api*, UInt8*, Void**, Fts5Tokenizer*) -> Int32)
    xCreateFunction : ((Fts5Api*, UInt8*, Void*, Fts5ExtensionFunction, (Void* -> Void)) -> Int32)
  end
  ...
  alias Sqlite3Callback = ((Void*, Int32, UInt8**, UInt8**) -> Int32)
  ...
  fun sqlite3_libversion : UInt8*
  fun sqlite3_sourceid : UInt8*
  fun sqlite3_libversion_number : Int32
  fun sqlite3_compileoption_used(z_opt_name : UInt8*) : Int32
  fun sqlite3_compileoption_get(n : Int32) : UInt8*
  fun sqlite3_threadsafe : Int32
  fun sqlite3_close(arg1 : Sqlite3*) : Int32
  fun sqlite3_close_v2(arg1 : Sqlite3*) : Int32
  fun sqlite3_exec(arg1 : Sqlite3*, sql : UInt8*, callback : ((Void*, Int32, UInt8**, UInt8**) -> Int32), arg2 : Void*, errmsg : UInt8**) : Int32
  ...
  fun sqlite3_complete(sql : UInt8*) : Int32
  ...
  fun sqlite3_get_table(db : Sqlite3*, z_sql : UInt8*, paz_result : UInt8***, pn_row : Int32*, pn_column : Int32*, pz_errmsg : UInt8**) : Int32
  fun sqlite3_free_table(result : UInt8**) : Void
  fun sqlite3_mprintf(arg1 : UInt8*) : UInt8*
  fun sqlite3_vmprintf(arg1 : UInt8*, arg2 : X__va_list_tag*) : UInt8*
  fun sqlite3_snprintf(arg1 : Int32, arg2 : UInt8*, arg3 : UInt8*) : UInt8*
  fun sqlite3_vsnprintf(arg1 : Int32, arg2 : UInt8*, arg3 : UInt8*, arg4 : X__va_list_tag*) : UInt8*
  ...
  fun sqlite3_set_authorizer(arg1 : Sqlite3*, x_auth : ((Void*, Int32, UInt8*, UInt8*, UInt8*, UInt8*) -> Int32), p_user_data : Void*) : Int32
  fun sqlite3_trace(arg1 : Sqlite3*, x_trace : ((Void*, UInt8*) -> Void), arg2 : Void*) : Void*
  fun sqlite3_profile(arg1 : Sqlite3*, x_profile : ((Void*, UInt8*, Sqlite3Uint64) -> Void), arg2 : Void*) : Void*
  fun sqlite3_progress_handler(arg1 : Sqlite3*, arg2 : Int32, arg3 : (Void* -> Int32), arg4 : Void*) : Void
  fun sqlite3_open(filename : UInt8*, pp_db : Sqlite3**) : Int32
  fun sqlite3_open16(filename : Void*, pp_db : Sqlite3**) : Int32
  fun sqlite3_open_v2(filename : UInt8*, pp_db : Sqlite3**, flags : Int32, z_vfs : UInt8*) : Int32
  fun sqlite3_uri_parameter(z_filename : UInt8*, z_param : UInt8*) : UInt8*
  fun sqlite3_uri_boolean(z_file : UInt8*, z_param : UInt8*, b_default : Int32) : Int32
  fun sqlite3_uri_int64(arg1 : UInt8*, arg2 : UInt8*, arg3 : Sqlite3Int64) : Sqlite3Int64
  fun sqlite3_errcode(db : Sqlite3*) : Int32
  fun sqlite3_extended_errcode(db : Sqlite3*) : Int32
  fun sqlite3_errmsg(arg1 : Sqlite3*) : UInt8*
  fun sqlite3_errmsg16(arg1 : Sqlite3*) : Void*
  fun sqlite3_errstr(arg1 : Int32) : UInt8*
  fun sqlite3_limit(arg1 : Sqlite3*, id : Int32, new_val : Int32) : Int32
  fun sqlite3_prepare(db : Sqlite3*, z_sql : UInt8*, n_byte : Int32, pp_stmt : Sqlite3Stmt**, pz_tail : UInt8**) : Int32
  fun sqlite3_prepare_v2(db : Sqlite3*, z_sql : UInt8*, n_byte : Int32, pp_stmt : Sqlite3Stmt**, pz_tail : UInt8**) : Int32
  ...
  fun sqlite3_sql(p_stmt : Sqlite3Stmt*) : UInt8*
  ...
  fun sqlite3_bind_text(arg1 : Sqlite3Stmt*, arg2 : Int32, arg3 : UInt8*, arg4 : Int32, arg5 : (Void* -> Void)) : Int32
  fun sqlite3_bind_text16(arg1 : Sqlite3Stmt*, arg2 : Int32, arg3 : Void*, arg4 : Int32, arg5 : (Void* -> Void)) : Int32
  fun sqlite3_bind_text64(arg1 : Sqlite3Stmt*, arg2 : Int32, arg3 : UInt8*, arg4 : Sqlite3Uint64, arg5 : (Void* -> Void), encoding : UInt8) : Int32
  ...
  fun sqlite3_bind_parameter_name(arg1 : Sqlite3Stmt*, arg2 : Int32) : UInt8*
  fun sqlite3_bind_parameter_index(arg1 : Sqlite3Stmt*, z_name : UInt8*) : Int32
  fun sqlite3_clear_bindings(arg1 : Sqlite3Stmt*) : Int32
  fun sqlite3_column_count(p_stmt : Sqlite3Stmt*) : Int32
  fun sqlite3_column_name(arg1 : Sqlite3Stmt*, n : Int32) : UInt8*
  fun sqlite3_column_name16(arg1 : Sqlite3Stmt*, n : Int32) : Void*
  fun sqlite3_column_database_name(arg1 : Sqlite3Stmt*, arg2 : Int32) : UInt8*
  fun sqlite3_column_database_name16(arg1 : Sqlite3Stmt*, arg2 : Int32) : Void*
  fun sqlite3_column_table_name(arg1 : Sqlite3Stmt*, arg2 : Int32) : UInt8*
  fun sqlite3_column_table_name16(arg1 : Sqlite3Stmt*, arg2 : Int32) : Void*
  fun sqlite3_column_origin_name(arg1 : Sqlite3Stmt*, arg2 : Int32) : UInt8*
  fun sqlite3_column_origin_name16(arg1 : Sqlite3Stmt*, arg2 : Int32) : Void*
  fun sqlite3_column_decltype(arg1 : Sqlite3Stmt*, arg2 : Int32) : UInt8*
  ...
  fun sqlite3_create_function(db : Sqlite3*, z_function_name : UInt8*, n_arg : Int32, e_text_rep : Int32, p_app : Void*, x_func : ((Sqlite3Context*, Int32, Sqlite3Value**) -> Void), x_step : ((Sqlite3Context*, Int32, Sqlite3Value**) -> Void), x_final : (Sqlite3Context* -> Void)) : Int32
  ...
  fun sqlite3_create_function_v2(db : Sqlite3*, z_function_name : UInt8*, n_arg : Int32, e_text_rep : Int32, p_app : Void*, x_func : ((Sqlite3Context*, Int32, Sqlite3Value**) -> Void), x_step : ((Sqlite3Context*, Int32, Sqlite3Value**) -> Void), x_final : (Sqlite3Context* -> Void), x_destroy : (Void* -> Void)) : Int32
  ...
  fun sqlite3_result_error(arg1 : Sqlite3Context*, arg2 : UInt8*, arg3 : Int32) : Void
  ...
  fun sqlite3_result_text(arg1 : Sqlite3Context*, arg2 : UInt8*, arg3 : Int32, arg4 : (Void* -> Void)) : Void
  fun sqlite3_result_text64(arg1 : Sqlite3Context*, arg2 : UInt8*, arg3 : Sqlite3Uint64, arg4 : (Void* -> Void), encoding : UInt8) : Void
  ...
  fun sqlite3_create_collation(arg1 : Sqlite3*, z_name : UInt8*, e_text_rep : Int32, p_arg : Void*, x_compare : ((Void*, Int32, Void*, Int32, Void*) -> Int32)) : Int32
  fun sqlite3_create_collation_v2(arg1 : Sqlite3*, z_name : UInt8*, e_text_rep : Int32, p_arg : Void*, x_compare : ((Void*, Int32, Void*, Int32, Void*) -> Int32), x_destroy : (Void* -> Void)) : Int32
  ...
  fun sqlite3_collation_needed(arg1 : Sqlite3*, arg2 : Void*, arg3 : ((Void*, Sqlite3*, Int32, UInt8*) -> Void)) : Int32
  ...
  fun sqlite3_db_filename(db : Sqlite3*, z_db_name : UInt8*) : UInt8*
  fun sqlite3_db_readonly(db : Sqlite3*, z_db_name : UInt8*) : Int32
  ...
  fun sqlite3_update_hook(arg1 : Sqlite3*, arg2 : ((Void*, Int32, UInt8*, UInt8*, Sqlite3Int64) -> Void), arg3 : Void*) : Void*
  ...
  fun sqlite3_table_column_metadata(db : Sqlite3*, z_db_name : UInt8*, z_table_name : UInt8*, z_column_name : UInt8*, pz_data_type : UInt8**, pz_coll_seq : UInt8**, p_not_null : Int32*, p_primary_key : Int32*, p_autoinc : Int32*) : Int32
  fun sqlite3_load_extension(db : Sqlite3*, z_file : UInt8*, z_proc : UInt8*, pz_err_msg : UInt8**) : Int32
  ...
  fun sqlite3_create_module(db : Sqlite3*, z_name : UInt8*, p : Sqlite3Module*, p_client_data : Void*) : Int32
  fun sqlite3_create_module_v2(db : Sqlite3*, z_name : UInt8*, p : Sqlite3Module*, p_client_data : Void*, x_destroy : (Void* -> Void)) : Int32
  fun sqlite3_declare_vtab(arg1 : Sqlite3*, z_sql : UInt8*) : Int32
  fun sqlite3_overload_function(arg1 : Sqlite3*, z_func_name : UInt8*, n_arg : Int32) : Int32
  fun sqlite3_blob_open(arg1 : Sqlite3*, z_db : UInt8*, z_table : UInt8*, z_column : UInt8*, i_row : Sqlite3Int64, flags : Int32, pp_blob : Sqlite3Blob**) : Int32
  ...
  fun sqlite3_vfs_find(z_vfs_name : UInt8*) : Sqlite3Vfs*
  ...
  fun sqlite3_file_control(arg1 : Sqlite3*, z_db_name : UInt8*, op : Int32, arg2 : Void*) : Int32
  ...
  fun sqlite3_backup_init(p_dest : Sqlite3*, z_dest_name : UInt8*, p_source : Sqlite3*, z_source_name : UInt8*) : Sqlite3Backup*
  ...
  fun sqlite3_stricmp(arg1 : UInt8*, arg2 : UInt8*) : Int32
  fun sqlite3_strnicmp(arg1 : UInt8*, arg2 : UInt8*, arg3 : Int32) : Int32
  fun sqlite3_strglob(z_glob : UInt8*, z_str : UInt8*) : Int32
  fun sqlite3_strlike(z_glob : UInt8*, z_str : UInt8*, c_esc : UInt32) : Int32
  fun sqlite3_log(i_err_code : Int32, z_format : UInt8*) : Void
  fun sqlite3_wal_hook(arg1 : Sqlite3*, arg2 : ((Void*, Sqlite3*, UInt8*, Int32) -> Int32), arg3 : Void*) : Void*
  fun sqlite3_wal_autocheckpoint(db : Sqlite3*, n : Int32) : Int32
  fun sqlite3_wal_checkpoint(db : Sqlite3*, z_db : UInt8*) : Int32
  fun sqlite3_wal_checkpoint_v2(db : Sqlite3*, z_db : UInt8*, e_mode : Int32, pn_log : Int32*, pn_ckpt : Int32*) : Int32
  ...
  fun sqlite3_preupdate_hook(db : Sqlite3*, x_pre_update : ((Void*, Sqlite3*, Int32, UInt8*, UInt8*, Sqlite3Int64, Sqlite3Int64) -> Void), arg1 : Void*) : Void*
  ...
  fun sqlite3_snapshot_get(db : Sqlite3*, z_schema : UInt8*, pp_snapshot : Sqlite3Snapshot**) : Int32
  fun sqlite3_snapshot_open(db : Sqlite3*, z_schema : UInt8*, p_snapshot : Sqlite3Snapshot*) : Int32
  fun sqlite3_snapshot_free(arg1 : Sqlite3Snapshot*) : Void
  fun sqlite3_snapshot_cmp(p1 : Sqlite3Snapshot*, p2 : Sqlite3Snapshot*) : Int32
  fun sqlite3_rtree_geometry_callback(db : Sqlite3*, z_geom : UInt8*, x_geom : ((Sqlite3RtreeGeometry*, Int32, Sqlite3RtreeDbl*, Int32*) -> Int32), p_context : Void*) : Int32
  fun sqlite3_rtree_query_callback(db : Sqlite3*, z_query_func : UInt8*, x_query_func : (Sqlite3RtreeQueryInfo* -> Int32), p_context : Void*, x_destructor : (Void* -> Void)) : Int32
end
